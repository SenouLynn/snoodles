...
**Step 2:** Once derive-prompt produces the refined prompt, invoke the `snoodles:brainstorm` skill. Pass it the refined prompt. Follow it to explore context, design, and produce a phased plan doc.
